...
const qwenImageModels: AIImageModelCard[] = [
  {
    description:
      'Qwen-Image-Edit supports multi-picture input and multi-picture output, and can accurately modify text in pictures, add, delete or move objects, change subject movements, transfer picture styles and enhance picture details.',
