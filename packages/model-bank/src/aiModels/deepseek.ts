...
const deepseekChatModels: AIChatModelCard[] = [
  {
    ...
    description:
      'DeepSeek V4.1 Flash is a fast, cost-efficient 552B MoE model featuring native multimodal vision and an asymmetric architecture. Delivering higher throughput, vastly reduced KV cache overhead, and intelligence outperforming V4 Pro, it excels at agentic workflows and rapid reasoning.',
